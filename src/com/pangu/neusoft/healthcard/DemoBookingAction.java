...
public class DemoBookingAction {
	...
	public DemoBookingAction(Activity activity){
		...
		if(sp.getString("cardnum", "").equals("")||sp.getString("owner", "").equals("")){
			...
			new AsyncTask<Void, Void, Boolean>() {
				...
				protected Boolean doInBackground(Void... params) {
					...
					int serialNumber=sp.getInt("serialNumber", 0);
					serialNumber+=1;
					...
					//if (obj != null) {
						String isSuccessful="预约成功";
						
						if(isSuccessful.equals("true")){
							SerialNumber = serialNumber+"";
						}
						
						String recodeid = serialNumber+"";
							...
							Setting.bookingdata.setSerialNumber(serialNumber+"");
